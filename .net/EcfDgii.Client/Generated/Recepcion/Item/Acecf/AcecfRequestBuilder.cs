...
{
    /// <summary>
    /// Builds and executes requests for operations under \recepcion\{message-id}\acecf
    /// </summary>
    ...
    public partial class AcecfRequestBuilder : BaseRequestBuilder
    {
        ...
        public AcecfRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/recepcion/{message%2Did}/acecf", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::EcfDgii.Client.Generated.Recepcion.Item.Acecf.AcecfRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AcecfRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/recepcion/{message%2Did}/acecf", rawUrl)
        {
        }
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class AcecfRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
