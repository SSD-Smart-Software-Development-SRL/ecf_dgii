...
public class EcfDetallesItemsItem
{
    ...
    [XmlIgnore] private Collection<EcfDetallesItemsItemTablaSubcantidadSubcantidadItem> _tablaSubcantidad;
    ...
    public EcfDetallesItemsItem()
    {
        ...
        _tablaSubcantidad = new Collection<EcfDetallesItemsItemTablaSubcantidadSubcantidadItem>();
    ...
    ///     <para xml:lang="en">Maximum inclusive value: 10000.</para>
    ...
    [XmlElement("Retencion", Form = XmlSchemaForm.Unqualified)]
    public EcfDetallesItemsItemRetencion Retencion { get; set; }
    ...
    /// </summary>
    [RegularExpression("[0-9]{1,16}(\\.[0-9]{1,2})?")]
    [XmlElement("CantidadReferencia", Form = XmlSchemaForm.Unqualified)]
    public decimal CantidadReferencia { get; set; }

    /// <summary>
    ///     <para xml:lang="en">Gets or sets a value indicating whether the CantidadReferencia property is specified.</para>
    /// </summary>
    [XmlIgnore]
    public bool CantidadReferenciaSpecified { get; set; }

    [XmlElement("UnidadReferencia", Form = XmlSchemaForm.Unqualified)]
    public UnidadMedidaType UnidadReferencia { get; set; }

    /// <summary>
    ///     <para xml:lang="en">Gets or sets a value indicating whether the UnidadReferencia property is specified.</para>
    /// </summary>
    [XmlIgnore]
    public bool UnidadReferenciaSpecified { get; set; }

    [XmlArray("TablaSubcantidad", Form = XmlSchemaForm.Unqualified)]
    [XmlArrayItem("SubcantidadItem", Form = XmlSchemaForm.Unqualified)]
    public Collection<EcfDetallesItemsItemTablaSubcantidadSubcantidadItem> TablaSubcantidad
    {
        get => _tablaSubcantidad;
        private set => _tablaSubcantidad = value;
    }

    /// <summary>
    ///     <para xml:lang="en">Gets a value indicating whether the TablaSubcantidad collection is empty.</para>
    /// </summary>
    [XmlIgnore]
    public bool TablaSubcantidadSpecified => TablaSubcantidad.Count != 0;
    ...
    [XmlElement("GradosAlcohol", Form = XmlSchemaForm.Unqualified)]
    public decimal GradosAlcohol { get; set; }

    /// <summary>
    ///     <para xml:lang="en">Gets or sets a value indicating whether the GradosAlcohol property is specified.</para>
    /// </summary>
    [XmlIgnore]
    public bool GradosAlcoholSpecified { get; set; }
    ...
    /// </summary>
    [RegularExpression("[0-9]{1,16}(\\.[0-9]{1,2})?")]
    [XmlElement("PrecioUnitarioReferencia", Form = XmlSchemaForm.Unqualified)]
    public decimal PrecioUnitarioReferencia { get; set; }

    /// <summary>
    ///     <para xml:lang="en">Gets or sets a value indicating whether the PrecioUnitarioReferencia property is specified.</para>
    /// </summary>
    [XmlIgnore]
    public bool PrecioUnitarioReferenciaSpecified { get; set; }
    ...
    [XmlElement("Mineria", Form = XmlSchemaForm.Unqualified)]
    public EcfDetallesItemsItemMineria Mineria { get; set; }
