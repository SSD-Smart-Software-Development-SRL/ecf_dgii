...
public class EcfDetallesItemsItemRetencion
{
    ...
    /// <summary>
    ///     <para xml:lang="en">
    ///         Gets or sets a value indicating whether the IndicadorAgenteRetencionoPercepcion property is
    ///         specified.
    ///     </para>
    /// </summary>
    [XmlIgnore]
    public bool IndicadorAgenteRetencionoPercepcionSpecified { get; set; }
