...
public class EcfEncabezadoEmisor
{
    ...
    [MinLength(1)]
    [MaxLength(60)]
    [XmlElement("CodigoVendedor", Form = XmlSchemaForm.Unqualified)]
    ...
    [MinLength(1)]
    [MaxLength(20)]
    [XmlElement("ZonaVenta", Form = XmlSchemaForm.Unqualified)]
    ...
    [MinLength(1)]
    [MaxLength(20)]
    [XmlElement("RutaVenta", Form = XmlSchemaForm.Unqualified)]
