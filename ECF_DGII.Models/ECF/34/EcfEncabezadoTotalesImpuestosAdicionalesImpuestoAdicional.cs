...
public class EcfEncabezadoTotalesImpuestosAdicionalesImpuestoAdicional
{
    ...
    /// <summary>
    ///     <para xml:lang="en">Gets or sets a value indicating whether the TipoImpuesto property is specified.</para>
    /// </summary>
    [XmlIgnore]
    public bool TipoImpuestoSpecified { get; set; }
    ...
    /// <summary>
    ///     <para xml:lang="en">Gets or sets a value indicating whether the TasaImpuestoAdicional property is specified.</para>
    /// </summary>
    [XmlIgnore]
    public bool TasaImpuestoAdicionalSpecified { get; set; }
