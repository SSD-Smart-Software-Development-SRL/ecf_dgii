...
public class EcfPaginacionPagina
{
    ...
    /// </summary>
    [RegularExpression("[0-9]{1,16}(\\.[0-9]{1,2})?")]
    [XmlElement("SubtotalMontoGravado1Pagina", Form = XmlSchemaForm.Unqualified)]
    public decimal SubtotalMontoGravado1Pagina { get; set; }

    /// <summary>
    ///     <para xml:lang="en">Gets or sets a value indicating whether the SubtotalMontoGravado1Pagina property is specified.</para>
    /// </summary>
    [XmlIgnore]
    public bool SubtotalMontoGravado1PaginaSpecified { get; set; }
    ...
    /// </summary>
    [RegularExpression("[0-9]{1,16}(\\.[0-9]{1,2})?")]
    [XmlElement("SubtotalMontoGravado2Pagina", Form = XmlSchemaForm.Unqualified)]
    public decimal SubtotalMontoGravado2Pagina { get; set; }

    /// <summary>
    ///     <para xml:lang="en">Gets or sets a value indicating whether the SubtotalMontoGravado2Pagina property is specified.</para>
    /// </summary>
    [XmlIgnore]
    public bool SubtotalMontoGravado2PaginaSpecified { get; set; }
    ...
    /// </summary>
    [RegularExpression("[0-9]{1,16}(\\.[0-9]{1,2})?")]
    [XmlElement("SubtotalItbis1Pagina", Form = XmlSchemaForm.Unqualified)]
    public decimal SubtotalItbis1Pagina { get; set; }

    /// <summary>
    ///     <para xml:lang="en">Gets or sets a value indicating whether the SubtotalItbis1Pagina property is specified.</para>
    /// </summary>
    [XmlIgnore]
    public bool SubtotalItbis1PaginaSpecified { get; set; }
    ...
    /// </summary>
    [RegularExpression("[0-9]{1,16}(\\.[0-9]{1,2})?")]
    [XmlElement("SubtotalItbis2Pagina", Form = XmlSchemaForm.Unqualified)]
    public decimal SubtotalItbis2Pagina { get; set; }

    /// <summary>
    ///     <para xml:lang="en">Gets or sets a value indicating whether the SubtotalItbis2Pagina property is specified.</para>
    /// </summary>
    [XmlIgnore]
    public bool SubtotalItbis2PaginaSpecified { get; set; }
