...
open class EcfDgiiClientAPIConfiguration: @unchecked Sendable {
    ...
    public init(
        basePath: String = "https://api.test.ecfx.ssd.com.do",
    ...
    public static let shared = EcfDgiiClientAPIConfiguration()
}
...
open class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    required public init(method: String, URLString: String, parameters: [String: any Sendable]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: EcfDgiiClientAPIConfiguration = EcfDgiiClientAPIConfiguration.shared) {
        self.method = method
