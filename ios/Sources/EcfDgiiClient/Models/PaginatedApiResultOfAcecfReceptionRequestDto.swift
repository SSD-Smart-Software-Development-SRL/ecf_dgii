//
// PaginatedApiResultOfAcecfReceptionRequestDto.swift
//
...
public struct PaginatedApiResultOfAcecfReceptionRequestDto: Sendable, Codable, Hashable {
    ...
    public var values: [AcecfReceptionRequestDto]?
    ...
    public init(nextPageUri: String?, values: [AcecfReceptionRequestDto]? = nil, total: Int? = nil, page: Int? = nil, limit: Int? = nil, nextPage: Int? = nil, previousPage: Int? = nil) {
