//
// PaginatedApiResultOfEcfReceptionRequestDto.swift
//
...
public struct PaginatedApiResultOfEcfReceptionRequestDto: Sendable, Codable, Hashable {
    ...
    public var values: [EcfReceptionRequestDto]?
    ...
    public init(nextPageUri: String?, values: [EcfReceptionRequestDto]? = nil, total: Int? = nil, page: Int? = nil, limit: Int? = nil, nextPage: Int? = nil, previousPage: Int? = nil) {
