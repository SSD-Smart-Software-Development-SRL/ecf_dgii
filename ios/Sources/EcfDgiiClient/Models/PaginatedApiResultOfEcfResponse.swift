//
// PaginatedApiResultOfEcfResponse.swift
//
...
public struct PaginatedApiResultOfEcfResponse: Sendable, Codable, Hashable {
    ...
    public init(nextPageUri: String?, values: [EcfResponse]? = nil, total: Int? = nil, page: Int? = nil, limit: Int? = nil, nextPage: Int? = nil, previousPage: Int? = nil) {
