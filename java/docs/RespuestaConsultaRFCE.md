...
|**secuenciaUtilizada** | **Boolean** | Indica si el número de secuencia puede ser reutilizado. &#x60;true&#x60; si la secuencia NO puede reutilizarse (rechazado por motivos específicos);         &#x60;false&#x60; si la secuencia SÍ puede reutilizarse. |  [optional] |
...
|**mensajes** | [**List&lt;Mensaje&gt;**](Mensaje.md) | Mensajes y códigos asociados al estado de validación del e-CF recibido. Array de mensajes que proporcionan detalles adicionales sobre la validación. |  [optional] |
