...
public class ItemCantidadItem extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ItemCantidadItem.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ItemCantidadItem.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ItemCantidadItem' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ItemCantidadItem>() {
                @Override
                public void write(JsonWriter out, ItemCantidadItem value) throws IOException {
                ...
                @Override
                public ItemCantidadItem read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        ItemCantidadItem ret = new ItemCantidadItem();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for ItemCantidadItem: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ItemCantidadItem(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return ItemCantidadItem.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to ItemCantidadItem
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for ItemCantidadItem with anyOf schemas: BigDecimal, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of ItemCantidadItem given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ItemCantidadItem
     * @throws IOException if the JSON string is invalid with respect to ItemCantidadItem
     */
    public static ItemCantidadItem fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ItemCantidadItem.class);
    }

    /**
     * Convert an instance of ItemCantidadItem to an JSON string
     *
     * @return JSON string
     */
