...
public class MineriaPesoNetoKilogramo extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(MineriaPesoNetoKilogramo.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!MineriaPesoNetoKilogramo.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'MineriaPesoNetoKilogramo' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<MineriaPesoNetoKilogramo>() {
                @Override
                public void write(JsonWriter out, MineriaPesoNetoKilogramo value) throws IOException {
                ...
                @Override
                public MineriaPesoNetoKilogramo read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        MineriaPesoNetoKilogramo ret = new MineriaPesoNetoKilogramo();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for MineriaPesoNetoKilogramo: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public MineriaPesoNetoKilogramo(Object o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return MineriaPesoNetoKilogramo.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to MineriaPesoNetoKilogramo
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for MineriaPesoNetoKilogramo with anyOf schemas: BigDecimal, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of MineriaPesoNetoKilogramo given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of MineriaPesoNetoKilogramo
     * @throws IOException if the JSON string is invalid with respect to MineriaPesoNetoKilogramo
     */
    public static MineriaPesoNetoKilogramo fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, MineriaPesoNetoKilogramo.class);
    }

    /**
     * Convert an instance of MineriaPesoNetoKilogramo to an JSON string
     *
     * @return JSON string
     */
