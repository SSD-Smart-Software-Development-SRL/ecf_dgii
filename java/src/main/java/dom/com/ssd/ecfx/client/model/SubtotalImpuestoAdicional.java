...
public class SubtotalImpuestoAdicional {
  public SubtotalImpuestoAdicional() {}
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    @SuppressWarnings("unchecked") @Override public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!SubtotalImpuestoAdicional.class.isAssignableFrom(type.getRawType())) return null;
      final TypeAdapter<JsonElement> ea = gson.getAdapter(JsonElement.class);
      final TypeAdapter<SubtotalImpuestoAdicional> ta = gson.getDelegateAdapter(this, TypeToken.get(SubtotalImpuestoAdicional.class));
      return (TypeAdapter<T>) new TypeAdapter<SubtotalImpuestoAdicional>() {
        @Override public void write(JsonWriter out, SubtotalImpuestoAdicional v) throws IOException { ea.write(out, ta.toJsonTree(v).getAsJsonObject()); }
        @Override public SubtotalImpuestoAdicional read(JsonReader in) throws IOException { return ta.fromJsonTree(ea.read(in)); }
      }.nullSafe();
    }
  }
  public static SubtotalImpuestoAdicional fromJson(String s) throws IOException { return JSON.getGson().fromJson(s, SubtotalImpuestoAdicional.class); }
