...
public class TotalesMontoPeriodo extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(TotalesMontoPeriodo.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TotalesMontoPeriodo.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'TotalesMontoPeriodo' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<TotalesMontoPeriodo>() {
                @Override
                public void write(JsonWriter out, TotalesMontoPeriodo value) throws IOException {
                ...
                @Override
                public TotalesMontoPeriodo read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        TotalesMontoPeriodo ret = new TotalesMontoPeriodo();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for TotalesMontoPeriodo: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public TotalesMontoPeriodo(Object o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return TotalesMontoPeriodo.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to TotalesMontoPeriodo
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for TotalesMontoPeriodo with anyOf schemas: BigDecimal, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of TotalesMontoPeriodo given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of TotalesMontoPeriodo
     * @throws IOException if the JSON string is invalid with respect to TotalesMontoPeriodo
     */
    public static TotalesMontoPeriodo fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, TotalesMontoPeriodo.class);
    }

    /**
     * Convert an instance of TotalesMontoPeriodo to an JSON string
     *
     * @return JSON string
     */
