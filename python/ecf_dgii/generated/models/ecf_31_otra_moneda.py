...
class Ecf31OtraMoneda:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_impuestos_adicionales_otra_moneda(data: object) -> list[Ecf31ImpuestoAdicionalOtraMoneda] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for impuestos_adicionales_otra_moneda_type_0_item_data in (_impuestos_adicionales_otra_moneda_type_0):
                    impuestos_adicionales_otra_moneda_type_0_item = Ecf31ImpuestoAdicionalOtraMoneda.from_dict(impuestos_adicionales_otra_moneda_type_0_item_data)
