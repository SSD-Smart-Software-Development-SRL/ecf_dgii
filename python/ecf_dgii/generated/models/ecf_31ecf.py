    ...
    """ 
        Example:
            {'detallesItems': [{'indicadorFacturacion': 'NoFacturable_18Percent', 'tablaImpuestoAdicional':
                ...
                None, 'precioUnitarioItem': 4.145608029883936, 'gradosAlcohol': 2.027123023002322, 'tablaSubDescuento':
                ...
                '+00:00'))}, {'indicadorFacturacion': 'NoFacturable_18Percent', 'tablaImpuestoAdicional': [{'tipoImpuesto':
                None}, {'tipoImpuesto': None}], 'nombreItem': 'nombreItem', 'tablaSubcantidad': [{'codigoSubcantidad': '',
                ...
                tzinfo=datetime.timezone(datetime.timedelta(0), '+00:00')), 'numeroLinea': 7, 'recargoMonto': None,
                'cantidadItem': 9.301444243932576, 'unidadReferencia': '', 'retencion': '', 'precioUnitarioReferencia': None,
                'precioUnitarioItem': 4.145608029883936, 'gradosAlcohol': 2.027123023002322, 'tablaSubDescuento':
                [{'tipoSubDescuento': '$', 'subDescuentoPorcentaje': None, 'montoSubDescuento': None}, {'tipoSubDescuento': '$',
                'subDescuentoPorcentaje': None, 'montoSubDescuento': None}], 'montoItem': None, 'cantidadReferencia': None,
                'fechaElaboracion': datetime.datetime(2000, 1, 23, 4, 56, 7, tzinfo=datetime.timezone(datetime.timedelta(0),
                '+00:00'))}], 'descuentosORecargos': [{'numeroLinea': None, 'montoDescuentooRecargo': None,
                'descripcionDescuentooRecargo': 'descripcionDescuentooRecargo', 'indicadorNorma1007': '',
                ...
                'descripcionDescuentooRecargo': 'descripcionDescuentooRecargo', 'indicadorNorma1007': '',
                'indicadorFacturacionDescuentooRecargo': '', 'tipoAjuste': 'D', 'tipoValor': '', 'valorDescuentooRecargo': None,
                'montoDescuentooRecargoOtraMoneda': None}], 'informacionReferencia': '', 'subtotales': [{'lineas': None,
        ...
        Attributes:
            encabezado (Ecf31Encabezado):  Example: {'transporte': '', 'informacionesAdicionales': '', 'comprador':
        ...
        def _parse_subtotales(data: object) -> list[Ecf31Subtotal] | None | Unset:
            ...
            try:
                ...
                for subtotales_type_0_item_data in (_subtotales_type_0):
                    subtotales_type_0_item = Ecf31Subtotal.from_dict(subtotales_type_0_item_data)
        ...
        def _parse_descuentos_o_recargos(data: object) -> list[Ecf31DescuentoORecargo] | None | Unset:
            ...
            try:
                ...
                for descuentos_o_recargos_type_0_item_data in (_descuentos_o_recargos_type_0):
                    descuentos_o_recargos_type_0_item = Ecf31DescuentoORecargo.from_dict(descuentos_o_recargos_type_0_item_data)
        ...
        def _parse_paginacion(data: object) -> list[Ecf31Pagina] | None | Unset:
            ...
            try:
                ...
                for paginacion_type_0_item_data in (_paginacion_type_0):
                    paginacion_type_0_item = Ecf31Pagina.from_dict(paginacion_type_0_item_data)
