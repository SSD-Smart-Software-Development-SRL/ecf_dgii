    ...
    """ 
        Example:
            {'detallesItems': [{'indicadorFacturacion': 'NoFacturable_18Percent', 'tablaImpuestoAdicional':
                [{'tipoImpuesto': None}, {'tipoImpuesto': None}], 'nombreItem': 'nombreItem', 'tablaSubcantidad':
                ...
                'numeroLinea': 7, 'gradosAlcohol': 3.616076749251911, 'tablaSubDescuento': [{'tipoSubDescuento': '$',
                ...
                2.027123023002322, 'cantidadReferencia': None, 'fechaElaboracion': datetime.datetime(2000, 1, 23, 4, 56, 7,
                tzinfo=datetime.timezone(datetime.timedelta(0), '+00:00'))}, {'indicadorFacturacion': 'NoFacturable_18Percent',
                'tablaImpuestoAdicional': [{'tipoImpuesto': None}, {'tipoImpuesto': None}], 'nombreItem': 'nombreItem',
                ...
                '+00:00')), 'numeroLinea': 7, 'gradosAlcohol': 3.616076749251911, 'tablaSubDescuento': [{'tipoSubDescuento':
                '$', 'subDescuentoPorcentaje': None, 'montoSubDescuento': None}, {'tipoSubDescuento': '$',
                'subDescuentoPorcentaje': None, 'montoSubDescuento': None}], 'montoItem': None, 'unidadMedida': '', 'mineria':
                '', 'descripcionItem': 'descripcionItem', 'descuentoMonto': None, 'recargoMonto': None, 'cantidadItem':
                9.301444243932576, 'unidadReferencia': '', 'retencion': '', 'precioUnitarioReferencia': None,
                'precioUnitarioItem': 2.027123023002322, 'cantidadReferencia': None, 'fechaElaboracion': datetime.datetime(2000,
                1, 23, 4, 56, 7, tzinfo=datetime.timezone(datetime.timedelta(0), '+00:00'))}], 'descuentosORecargos':
                ...
                'descripcionDescuentooRecargo', 'indicadorNorma1007': '', 'indicadorFacturacionDescuentooRecargo': '',
                'tipoAjuste': 'D', 'tipoValor': '', 'valorDescuentooRecargo': None, 'montoDescuentooRecargoOtraMoneda': None}],
                'informacionReferencia': {'razonModificacion': 'razonModificacion', 'rncOtroContribuyente':
                'rncOtroContribuyente', 'codigoModificacion': 'AnulaElNCFModificado', 'ncfModificado': 'ncfModificado',
                'fechaNCFModificado': datetime.datetime(2000, 1, 23, 4, 56, 7, tzinfo=datetime.timezone(datetime.timedelta(0),
                '+00:00'))}, 'subtotales': [{'lineas': None, 'subTotalMontoGravadoI1': None, 'subTotaITBIS3': None,
                ...
                'subTotalMontoGravadoI2': None, 'subTotaITBIS1': None, 'descripcionSubtotal': 'descripcionSubtotal',
                'subTotaITBIS': None, 'numeroSubTotal': None, 'subTotalImpuestoAdicional': None, 'montoSubTotal': None, 'orden':
                None, 'subTotalExento': None}], 'encabezado': {'transporte': '', 'informacionesAdicionales': '', 'comprador':
                ...
                'montoGravadoTotal': 1.4658129805029452, 'valorPagar': None, 'montoTotal': None}}, 'paginacion':
        ...
        Attributes:
            encabezado (Ecf33Encabezado):  Example: {'transporte': '', 'informacionesAdicionales': '', 'comprador': '',
                'idDoc': {'tipoIngresos': '01', 'fechaLimitePago': datetime.datetime(2000, 1, 23, 4, 56, 7,
                tzinfo=datetime.timezone(datetime.timedelta(0), '+00:00')), 'encf': 'encf', 'fechaHasta':
                datetime.datetime(2000, 1, 23, 4, 56, 7, tzinfo=datetime.timezone(datetime.timedelta(0), '+00:00')),
                'tipoCuentaPago': '', 'fechaDesde': datetime.datetime(2000, 1, 23, 4, 56, 7,
            ...
            informacion_referencia (Ecf33InformacionReferencia):  Example: {'razonModificacion': 'razonModificacion',
        ...
        def _parse_subtotales(data: object) -> list[Ecf33Subtotal] | None | Unset:
            ...
            try:
                ...
                for subtotales_type_0_item_data in (_subtotales_type_0):
                    subtotales_type_0_item = Ecf33Subtotal.from_dict(subtotales_type_0_item_data)
        ...
        def _parse_descuentos_o_recargos(data: object) -> list[Ecf33DescuentoORecargo] | None | Unset:
            ...
            try:
                ...
                for descuentos_o_recargos_type_0_item_data in (_descuentos_o_recargos_type_0):
                    descuentos_o_recargos_type_0_item = Ecf33DescuentoORecargo.from_dict(descuentos_o_recargos_type_0_item_data)
        ...
        def _parse_paginacion(data: object) -> list[Ecf33Pagina] | None | Unset:
            ...
            try:
                ...
                for paginacion_type_0_item_data in (_paginacion_type_0):
                    paginacion_type_0_item = Ecf33Pagina.from_dict(paginacion_type_0_item_data)
