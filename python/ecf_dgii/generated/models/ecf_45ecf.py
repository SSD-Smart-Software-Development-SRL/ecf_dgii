    ...
    """ 
        Example:
            {'detallesItems': [{'indicadorFacturacion': 'NoFacturable_18Percent', 'tablaImpuestoAdicional':
                ...
                'cantidadItem': 9.301444243932576, 'unidadReferencia': '', 'precioUnitarioReferencia': None,
                'precioUnitarioItem': 2.027123023002322, 'gradosAlcohol': 3.616076749251911, 'tablaSubDescuento':
                [{'tipoSubDescuento': '$', 'subDescuentoPorcentaje': None, 'montoSubDescuento': None}, {'tipoSubDescuento': '$',
                'subDescuentoPorcentaje': None, 'montoSubDescuento': None}], 'montoItem': None, 'cantidadReferencia': None,
                'fechaElaboracion': datetime.datetime(2000, 1, 23, 4, 56, 7, tzinfo=datetime.timezone(datetime.timedelta(0),
                ...
                'totales': {'montoPeriodo': None, 'montoGravadoI3': None, 'montoGravadoI2': None, 'montoAvancePago': None,
                ...
                'paginacion': [{'subtotalItbis1Pagina': None, 'noLineaHasta': None, 'subtotalImpuestoAdicionalPagina': None,
        ...
        Attributes:
            encabezado (Ecf45Encabezado):  Example: {'transporte': '', 'informacionesAdicionales': '', 'comprador':
        ...
        def _parse_subtotales(data: object) -> list[Ecf45Subtotal] | None | Unset:
            ...
            try:
                ...
                for subtotales_type_0_item_data in (_subtotales_type_0):
                    subtotales_type_0_item = Ecf45Subtotal.from_dict(subtotales_type_0_item_data)
        ...
        def _parse_descuentos_o_recargos(data: object) -> list[Ecf45DescuentoORecargo] | None | Unset:
            ...
            try:
                ...
                for descuentos_o_recargos_type_0_item_data in (_descuentos_o_recargos_type_0):
                    descuentos_o_recargos_type_0_item = Ecf45DescuentoORecargo.from_dict(descuentos_o_recargos_type_0_item_data)
        ...
        def _parse_paginacion(data: object) -> list[Ecf45Pagina] | None | Unset:
            ...
            try:
                ...
                for paginacion_type_0_item_data in (_paginacion_type_0):
                    paginacion_type_0_item = Ecf45Pagina.from_dict(paginacion_type_0_item_data)
